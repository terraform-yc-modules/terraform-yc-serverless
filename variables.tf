...
variable "choosing_eventrouter_rule_target_type" {
  ...
  validation {
    ...
    error_message = "The choosing_eventrouter_rule_target_type must be one of: container, function, gateway_websocket_broadcast, workflow, logging, yds, ymq."
  }
}

# Container target variables
variable "eventrouter_rule_container_id" {
  description = "Container ID for the Event Router Rule container target"
  type        = string
  default     = "bbaq1kcpp2r0uqfgut5j"
}

variable "eventrouter_rule_container_revision_id" {
  description = "Container Revision ID for the Event Router Rule container target"
  type        = string
  default     = "bbabllu6ck26rehi97ie"
}

variable "eventrouter_rule_container_path" {
...
variable "eventrouter_rule_container_service_account_id" {
...
variable "eventrouter_rule_gateway_websocket_broadcast_gateway_id" {
  description = "Gateway ID for the Event Router Rule gateway websocket broadcast target"
  type        = string
  default     = "d5dl4tujg041khot5h6c"
}

variable "eventrouter_rule_gateway_websocket_broadcast_path" {
...
variable "eventrouter_rule_gateway_websocket_broadcast_service_account_id" {
...
variable "eventrouter_rule_logging_log_group_id" {
  description = "Log group ID for the Event Router Rule logging target"
  type        = string
  default     = "e23moaejmq8m74tssfu9"
}

variable "eventrouter_rule_logging_service_account_id" {
...
variable "eventrouter_rule_yds_stream_name" {
  description = "YDS stream name for the Event Router Rule YDS target"
  type        = string
  default     = "ydb-new"
}

variable "eventrouter_rule_yds_database" {
...
variable "eventrouter_rule_yds_service_account_id" {
...
variable "eventrouter_connector_yds_stream_name" {
  description = "YDS stream name for the connector"
  type        = string
  default     = "ydb-new"
}

variable "eventrouter_connector_yds_consumer" {
  description = "YDS consumer name for the connector"
  type        = string
  default     = "ydb-new"
}

variable "eventrouter_connector_yds_database" {
  description = "YDS database for the connector"
  type        = string
  default     = "/ru-central1/b1g3o4minpkuh10pd2rj/etn636at4r5dbg1vvh0u"
}

variable "eventrouter_connector_service_account_id" {
